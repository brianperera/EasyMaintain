...
using EasyMaintain.CoreWebMVC.Controllers;
...
namespace EasyMaintain.CoreWebMVC.Controllers
{
    ...
    public class _AccountController : Controller
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _logger = loggerFactory.CreateLogger<_AccountController>();
        }
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction(nameof(_AccountController.ResetPasswordConfirmation), "Account");
            }
