...
namespace EasyMaintain.CoreWebUI
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("CoreWebUIType", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();
