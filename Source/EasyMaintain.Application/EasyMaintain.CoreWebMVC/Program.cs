...
namespace EasyMaintain.CoreWebMVC
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("CoreWebMVCType", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();
